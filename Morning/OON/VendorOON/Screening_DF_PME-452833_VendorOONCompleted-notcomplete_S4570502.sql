...
File Name:  Screening_DF_PME-452833_VendorOONCompleted-notcomplete_S4570502
7/14/1982
*/
...
PRINT 'List the screeningxglog'
	SELECT *
	FROM screeningxglog
	WHERE (appid in(32167) or AppGID in (31377))
...
WHERE appid in (32167) and transmitdate is not null
...
VALUES ('32167', '109', 'LA-Tensas Parish', GETDATE(), '%3CCriminalSearchResult%20FirstName%3D%22%22%20MiddleName%3D%22%22%20LastName%3D%22%22%20DOB%3D%205%2F08%2F1964%22%20JursAbb%3D%22%22%20State%3D%22%22%20UserRef%3D%224570502-31377-32167%22%3E%3CSEARCH%20JurAbb%3D%22CTY%22%20hitcount%3D%220%22%20State%3D%22%22%20State_Extract_Date%3D%22%22%20RPI_Program_Revision_Date%3D%2212%2F15%2F06%22%20Search_Version%3D%222.8%22%20%2F%3E%3C%2FCriminalSearchResult%3E','4570502')
...
@InternalSiteID='4570502',
@InternalUserID='1',
@IPVC_APPID='32167',
@IPVC_ServiceName='Criminal',
@IPVC_SubService='OON',
@IPVC_XmlNode='<CriminalSearchResult FirstName="" MiddleName="" LastName="" DOB="05/08/1964" JursAbb="" State="" UserRef="32167"><SEARCH JurAbb="CTY" hitcount="0" State="" State_Extract_Date="" RPI_Program_Revision_Date="12/15/06" Search_Version="2.8" /><SEARCH JurAbb="CTY" hitcount="0" State="" State_Extract_Date="" RPI_Program_Revision_Date="12/15/06" Search_Version="2.8" /></CriminalSearchResult>'
...
VALUES ('31377', GETDATE(), 'OONC', 'Out of Network(s) returned.  Select Out of Network tab for details.', '1', '1', GETDATE(), '42089' , NULL,'4570502')
