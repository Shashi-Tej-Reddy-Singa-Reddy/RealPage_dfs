...
File Name:  Screening_DF_PME-456148_ReverseDecision_S1330129_B
PME-456148
*/
...
PRINT 'List the screeningxglog'
	SELECT *
	FROM screeningxglog
	WHERE (appid in(113586) or AppGID in (112770))
...
SELECT *
FROM ScreeningXgDecision  WHERE ApGId in (112770)

PRINT 'Update:Reverse decision'
Update screeningXgDecision
set dtID = 0,deccode = 0
where DecID = 163742 and apgid = 112770
...
VALUES ('112770', GETDATE(), 'SUBMIT', 'datafix - Reverse decision to no decision.', '1', '1', GETDATE(),'123863', NULL,'4380735')
