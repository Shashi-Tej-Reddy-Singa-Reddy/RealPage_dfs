...
File Name:  Screening_DF_PME-458067_ReverseDecision_S4973447_B
...
WHERE ApGId in(11636)


PRINT 'List the screeningxglog'
	SELECT *
	FROM screeningxglog
	WHERE (appid in(11940,11941) or AppGID in (11636))
...
SELECT *
FROM ScreeningXgDecision  WHERE ApGId in (11636)

PRINT 'Update:Reverse decision'
Update screeningXgDecision
set dtID = 0,deccode = 0
where DecID = 12723 and apgid = 11636
...
VALUES ('11636', GETDATE(), 'SUBMIT', 'datafix - Reverse decision to no decision.', '1', '1', GETDATE(),'22230', NULL,'4380735')
