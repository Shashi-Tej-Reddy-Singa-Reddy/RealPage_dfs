...
File Name:  Screening_DF_PME-465251_ReverseDecision_S1058820
...
PRINT 'List the screeningxglog'
	SELECT *
	FROM screeningxglog
	WHERE (appid in(61557) or AppGID in (43006))
...
SELECT *
FROM ScreeningXgDecision  WHERE ApGId in (43006)

PRINT 'Update:Reverse decision'
Update screeningXgDecision
set dtID = 0,deccode = 0
where DecID = 45413 and apgid = 43006
...
VALUES ('43006', GETDATE(), 'SUBMIT', 'datafix - Reverse decision to no decision.', '1', '1', GETDATE(),'116955', NULL,'4380735')
