...
File Name:  Screening_DF_PME-455920_ReverseDecision_S1330126
...
PRINT 'List the screeningxglog'
	SELECT *
	FROM screeningxglog
	WHERE (appid in(181310) or AppGID in (177779))
...
SELECT *
FROM ScreeningXgDecision  WHERE ApGId in (177779)

PRINT 'Update:Reverse decision'
Update screeningXgDecision
set dtID = 0,deccode = 0
where DecID = 168180 and apgid = 177779
...
VALUES ('177779', GETDATE(), 'SUBMIT', 'datafix - Reverse decision to no decision.', '1', '1', GETDATE(),'261725', NULL,'4380735')
