...
PRINT 'List the screeningxglog'
	SELECT *
	FROM screeningxglog
	WHERE (appid in(91603) or AppGID in (91176))
...
SELECT *
FROM ScreeningXgDecision  WHERE ApGId in (91176)

PRINT 'Update:Reverse decision'
Update screeningXgDecision
set dtID = 0,deccode = 0
where DecID = 101482 and apgid = 91176
