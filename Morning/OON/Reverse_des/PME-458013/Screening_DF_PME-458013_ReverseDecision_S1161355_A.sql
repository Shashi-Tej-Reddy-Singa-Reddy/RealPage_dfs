...
File Name:  Screening_DF_PME-458013_ReverseDecision_S1161355_A

Site: Crescent Landing

Applicant: Glenda McKinney
...
site id for the applicant is - 1161355
...
PRINT 'List the screeningxglog'
	SELECT *
	FROM screeningxglog
	WHERE (appid in(44786,44787) or AppGID in (44244))
...
SELECT *
FROM ScreeningXgDecision  WHERE ApGId in (44244)

PRINT 'Update:Reverse decision'
Update screeningXgDecision
set dtID = 0,deccode = 0
where DecID = 70654 and apgid = 44244
...
VALUES ('44244', GETDATE(), 'SUBMIT', 'datafix - Reverse decision to no decision.', '1', '1', GETDATE(),'94837', NULL,'4380735')
