...
File Name:  Screening_DF_PME-454364_ReverseDecision_S5353680
...
PRINT 'List the screeningxglog'
	SELECT *
	FROM screeningxglog
	WHERE (appid in(90) or AppGID in (53))
...
VALUES ('53', GETDATE(), 'SUBMIT', 'datafix - Reverse decision to no decision.', '1', '1', GETDATE(),'83', NULL,'5353680')
