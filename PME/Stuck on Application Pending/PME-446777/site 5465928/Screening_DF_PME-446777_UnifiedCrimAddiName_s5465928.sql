...
File: Screening_DF_PME-446777_UnifiedCrimAddiName_S5465928
...
where appid =  195 and ServiceName in ('Criminal','CriminalOutofNetwork')
...
where appid = 195  and deleted=0 and Servicename = 'Criminal' and Subservice IN ('SearchNote')
...
Select * from ScreeningXGXML with(nolock)
where appid = 195  and deleted=0 and Servicename = 'Credit' and Subservice IN ('Search', 'NameVariation')
