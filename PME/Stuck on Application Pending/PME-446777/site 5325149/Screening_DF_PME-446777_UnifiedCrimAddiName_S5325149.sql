...
File: Screening_DF_PME-446777_UnifiedCrimAddiName_S5325149
...
where appid =  401 and ServiceName in ('Criminal','CriminalOutofNetwork')
...
where appid = 401  and deleted=0 and Servicename = 'Criminal' and Subservice IN ('SearchNote')
...
Select * from ScreeningXGXML with(nolock)
where appid = 401  and deleted=0 and Servicename = 'Credit' and Subservice IN ('Search', 'NameVariation')
