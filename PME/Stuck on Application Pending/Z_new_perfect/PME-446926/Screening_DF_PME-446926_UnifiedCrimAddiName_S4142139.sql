...
File: Screening_DF_PME-446926_UnifiedCrimAddiName_S4142139
...
where appid =  49788 and ServiceName in ('Criminal','CriminalOutofNetwork')
...
where appid = 49788  and deleted=0 and Servicename = 'Criminal' and Subservice IN ('SearchNote')
...
Select * from ScreeningXGXML with(nolock)
where appid = 49788  and deleted=0 and Servicename = 'Credit' and Subservice IN ('Search', 'NameVariation')
