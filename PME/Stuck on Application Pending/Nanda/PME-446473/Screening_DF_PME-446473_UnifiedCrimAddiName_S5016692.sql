...
File: Screening_DF_PME-446473_UnifiedCrimAddiName_S5016692
...
where appid =  10349 and ServiceName in ('Criminal','CriminalOutofNetwork')
...
where appid = 10349  and deleted=0 and Servicename = 'Criminal' and Subservice IN ('SearchNote')
...
Select * from ScreeningXGXML with(nolock)
where appid = 10349  and deleted=0 and Servicename = 'Credit' and Subservice IN ('Search', 'NameVariation')
