...
where appid =  93529 and ServiceName in ('Criminal','CriminalOutofNetwork')
...
where appid = 93529  and deleted=0 and Servicename = 'Criminal' and Subservice IN ('SearchNote')
...
Select * from ScreeningXGXML with(nolock)
where appid = 93529  and deleted=0 and Servicename = 'Credit' and Subservice IN ('Search', 'NameVariation')
