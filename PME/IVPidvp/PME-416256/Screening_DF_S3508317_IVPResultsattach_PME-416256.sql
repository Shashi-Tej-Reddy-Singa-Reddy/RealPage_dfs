...
file : Screening_DF_S3508317_IVPResultsattach_PME-416256
...
WHERE id = 20117 and ConsumerID = '1371a093-f1b5-459c-98db-9874851e0b61' and TransactionID = 'fd30d05b-8fba-4b51-bc5d-e57d97192f50' and ServiceName = 'IncomeVerificationPremium'
...
where id = 20118 and ServiceName='IncomeVerificationPremium'


Print'After: IDVPstatus and results'
Select * from ScreeningServiceInfo
WHERE ConsumerID = '1371a093-f1b5-459c-98db-9874851e0b61' and TransactionID = 'fd30d05b-8fba-4b51-bc5d-e57d97192f50' and ServiceName = 'IncomeVerificationPremium'
