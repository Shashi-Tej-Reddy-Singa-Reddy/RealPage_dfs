...
File: Screening_DF_Screeningconfiguration_RemoveCrimDispute_PME-450051
PME-450051
...
WHERE appid = '10306' AND apgID =  '10229'AND cdSiteID = '5383480' and cdEntityID = '1049405' --entityId == PMCId
PRINT '  '
