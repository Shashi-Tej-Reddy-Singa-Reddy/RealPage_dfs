...
File: Screening_DF_Screeningconfiguration_RemoveCrimDispute_PME-447657
PME-447657
...
WHERE appid = '112382' AND apgID =  '111661'AND cdSiteID = '2441636' and cdEntityID = '1052860' --entityId == PMCId
PRINT '  '
