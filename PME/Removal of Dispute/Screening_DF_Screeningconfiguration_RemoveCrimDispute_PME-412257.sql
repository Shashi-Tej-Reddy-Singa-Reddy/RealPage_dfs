...
File: Screening_DF_Screeningconfiguration_RemoveCrimDispute_PME-412257
...
WHERE appid = '309'AND apgID =  '303'AND cdSiteID =  '4781705'and cdEntityID = '4677159' --entityId == PMCId
...
SET cdStatus = '2'
WHERE appid = '309'AND apgID =  '303'AND cdSiteID =  '4781705'and cdEntityID = '4677159' 
