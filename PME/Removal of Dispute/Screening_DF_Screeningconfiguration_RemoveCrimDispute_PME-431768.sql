...
File: Screening_DF_Screeningconfiguration_RemoveCrimDispute_PME-431768
...
WHERE appid = '12'AND apgID =  '12'AND cdSiteID = '5363304' and cdEntityID = '1511828' --entityId == PMCId
